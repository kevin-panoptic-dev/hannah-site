...
import asyncio
from pymodule import vibrenthe
from pymodule.utility import prismelt

# WARN: This is crucial for the function to working
...
class CreateGeminiModel(APIView):
    ...
    def fetch(cls, serializer):
        ...
        match request_type:
            ...
            case _:
                vibrenthe("Exception block is triggered", color=vibrenthe.BLUE)
                raise Exception(
