...
function Register() {
    ...
    const [warningMessage, setWarningMessage] = useState("placeholder");

    const login = async () => await api.post(LOGIN_PATH, { username: username });
    ...
    if (loading) {
        return <LoadingIndicator message="you are almost there..."></LoadingIndicator>;
    } else {
        return (
            <div className={styles.change_container}>
                <div className={styles.leftHalf}>
                    <div className={styles.leftContainer}>
                        ...
                        {showInvalid && <p className={styles.warning}>{warningMessage}</p>}
                    </div>
                ...
                <div className={styles.rightHalf}>
                    <p className={styles.rightTitle}>Build our future together</p>
                    <div className={styles.rightContainer}>
                        <div className={styles.rightBoxes}>
                            ...
                            <div className={styles.contentWrapper}>
                                <p className={styles.innerTitle}>Join my community</p>
                                <p className={styles.innerDescription}>
                                    Join a community of aspiring students and gain access to tools
                                    and resources to simplify your or your child's college
                                    admissions process.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className={styles.rightBoxes}>
                            ...
                            <div className={styles.contentWrapper}>
                                <p className={styles.innerTitle}>Make progress with me</p>
                                <p className={styles.innerDescription}>
                                    Partner with a mentor who understands your goals and will guide
                                    you step-by-step toward achieving them, empowering you to
