...
function Search() {
    ...
    const handleSubmit = async () => {
        if (userInput === undefined) {
            updateErrorMessage(
                `f;Used userInput must not be undefined, must be string.`
            );
            toErrorPage();
            return;
        }
        ...
        if (response) {
            ...
            const typingCharacters = () => {
                if (i < characterArray.length - 1) {
                    setContentText(
                        (previous) => previous + characterArray[i]
                    );
                    i++;
    ...
    if (isLoading) {
        return (
            <LoadingIndicator message="Out AI model is thinking, please wait..." />
        );
    } else {
        return (
                    ...
                    {response ? (
                        <>
                            ...
                            <p className={styles.think}>
                                Thinking for {thinkingTime} seconds
                            </p>
                        ...
                        <>
                            ...
                            <div className={styles.searchWrapper}>
                                <p className={styles.searchContent}>
                                    Type anything, and I'm ready to
                                    help!
                                </p>
                            </div>
                        </>
